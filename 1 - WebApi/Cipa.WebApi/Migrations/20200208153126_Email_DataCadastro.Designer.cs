...
namespace Cipa.WebApi.Migrations
{
    ...
    [Migration("20200208153126_Email_DataCadastro")]
    partial class Email_DataCadastro
    {
            ...
            modelBuilder.Entity("Cipa.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cargo = "Cargo Teste",
                            CodigoRecuperacao = new Guid("a291ece2-bfcb-40d9-95f3-b46b5d97c1be"),
                            ContaId = 1,
                            DataCadastro = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "teste@email.com",
                            ExpiracaoCodigoRecuperacao = new DateTime(2020, 2, 9, 12, 31, 25, 716, DateTimeKind.Local).AddTicks(5492),
                            Nome = "Teste",
                            Perfil = "SESMT",
