...
namespace Cipa.WebApi.Migrations
{
    ...
    [Migration("20191223201429_Correcao_TemplatesEmails")]
    partial class Correcao_TemplatesEmails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cipa.Domain.Entities.Eleicao", b =>
                {
                    ...
                    b.Property<DateTime>("DataFinalizacaoPrevista");
            ...
            modelBuilder.Entity("Cipa.Domain.Entities.TemplateEmail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
...
Etapa Atual: <strong>@ETAPA_ATUAL</strong>",
                        ...
                        new
                        {
                            ...
                            ContaId = 1,
                            Template = @" Ocorreu um erro ao finalizar a etapa atual da eleição da CIPA, que está sendo realizada na empresa @EMPRESA_CNPJ. Por favor, verifique.<br><br>
            ...
            modelBuilder.Entity("Cipa.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cargo = "Cargo Teste",
                            CodigoRecuperacao = new Guid("56298cf1-3f1c-432f-8894-9d479462b5b3"),
                            ContaId = 1,
                            DataCadastro = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "teste@email.com",
                            ExpiracaoCodigoRecuperacao = new DateTime(2019, 12, 24, 17, 14, 28, 836, DateTimeKind.Local).AddTicks(2908),
                            Nome = "Teste",
                            Perfil = "SESMT",
            ...
            modelBuilder.Entity("Cipa.Domain.Entities.ProcessamentoEtapa", b =>
                {
                    ...
                    b.HasOne("Cipa.Domain.Entities.EtapaCronograma", "EtapaCronogramaAnterior")
                        .WithOne()
                        .HasForeignKey("Cipa.Domain.Entities.ProcessamentoEtapa", "EtapaCronogramaAnteriorId");

                    b.HasOne("Cipa.Domain.Entities.EtapaCronograma", "EtapaCronograma")
                        .WithOne()
                        .HasForeignKey("Cipa.Domain.Entities.ProcessamentoEtapa", "EtapaCronogramaId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
